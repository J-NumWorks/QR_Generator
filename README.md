...
Run QRgenerator.py on your computer from whatever you use to run Python files.

Enter the url of the code you want to create.
Enter a name of the .png file you want.
